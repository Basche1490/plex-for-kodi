        ...
        <control type="group">
            ...
            <control type="grouplist">
                ...
                <control type="button">
                    ...
                    <label>$ADDON[script.plexmod.zidoo 32312]</label>
                </control>
            </control>
                ...
                {% block streams %}
                    <control type="grouplist">
                        ...
                        <control type="button">
                            ...
                            <texturefocus colordiffuse="40000000" border="8">script.plex/white-square-rounded-top-padded.png</texturefocus>
                            <texturenofocus colordiffuse="40000000" border="8">script.plex/white-square-rounded-top-padded.png</texturenofocus>
                            <label>[UPPERCASE]$ADDON[script.plexmod.zidoo 32048][/UPPERCASE]</label>
                        </control>
                        <control type="label">
                            <width>auto</width>
                            <height>{{ vscale(34) }}</height>
                        ...
                        <control type="button">
                            ...
                            <texturefocus colordiffuse="40000000" border="8">script.plex/white-square-rounded-top-padded.png</texturefocus>
                            <texturenofocus colordiffuse="40000000" border="8">script.plex/white-square-rounded-top-padded.png</texturenofocus>
                            <label>[UPPERCASE]$ADDON[script.plexmod.zidoo 32396][/UPPERCASE]</label>
                        </control>
                        <control type="label">
                            <visible>!String.IsEmpty(Window.Property(subtitles))</visible>
                            <width>auto</width>
    ...
    <control type="grouplist" id="60">
        ...
        <control type="group" id="501">
            ...
            <control type="label">
                ...
                <aligny>center</aligny>
                <textcolor>FFFFFFFF</textcolor>
                <label>[UPPERCASE]$ADDON[script.plexmod.zidoo 32953][/UPPERCASE]</label>
            </control>
        ...
        <control type="group" id="502">
            ...
            <control type="label">
                ...
                <aligny>center</aligny>
                <textcolor>FFFFFFFF</textcolor>
                <label>[UPPERCASE]$ADDON[script.plexmod.zidoo 32305][/UPPERCASE]</label>
            </control>
