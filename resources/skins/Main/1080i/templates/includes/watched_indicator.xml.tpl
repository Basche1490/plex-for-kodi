{% with xoff = xoff|default(158) & yoff = yoff|default(0) & uw_size = uw_size|default(32) & wbg_w = wbg_w|default(32) & wbg_h = wbg_h|default(32) & scale_fac = indicators.scale|get(scale, "small", 1.0) %}
    ...
    <control type="image">
        ...
        <texture fallback="script.plex/indicators/{{ indicators.assets.unwatched }}">special://profile/addon_data/script.plexmod.zidoo/media/{{ indicators.assets.unwatched }}</texture>
    </control>
    {% else %}
    <control type="group">
        ...
        <control type="image">
            ...
            <texture fallback="script.plex/indicators/{{ indicators.assets.watched }}">special://profile/addon_data/script.plexmod.zidoo/media/{{ indicators.assets.watched }}</texture>
        </control>
    </control>
    {% endif %}
    {% if with_count %}
