...
<control type="group" id="200">
    ...
    <control type="group">
        ...
        <control type="label">
            ...
            <aligny>center</aligny>
            <textcolor>FFFFFFFF</textcolor>
            <label>[UPPERCASE]$ADDON[script.plexmod.zidoo 32430][/UPPERCASE]</label>
        </control>
    </control>
    <control type="group">
...
<control type="group">
    ...
    <control type="label">
        ...
        <align>center</align>
        <textcolor>FFFFFFFF</textcolor>
        <label>[B]$ADDON[script.plexmod.zidoo 32452][/B]</label>
    </control>
    <control type="label">
        <scroll>false</scroll>
        <posx>60</posx>
        ...
        <label>$ADDON[script.plexmod.zidoo 32453]</label>
    </control>
</control>
...
<control type="group">
    ...
    <control type="label">
        ...
        <align>center</align>
        <textcolor>FFFFFFFF</textcolor>
        <label>[B]$ADDON[script.plexmod.zidoo 34020][/B]</label>
    </control>
    <control type="label">
        <scroll>false</scroll>
        <posx>60</posx>
        ...
        <align>center</align>
        <textcolor>FFCCCCCC</textcolor>
        <label>[B]$ADDON[script.plexmod.zidoo 34021][/B]</label>
    </control>
</control>
