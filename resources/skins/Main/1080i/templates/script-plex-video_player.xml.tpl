...
<control type="group">
    ...
    <control type="group" id="50">
        ...
        <control type="label">
            ...
            <label>[UPPERCASE]$ADDON[script.plexmod.zidoo 32438][/UPPERCASE]</label>
        </control>
            ...
            <control type="group">
                ...
                <control type="group">
                    ...
                    <control type="label">
                        ...
                        <aligny>center</aligny>
                        <textcolor>FFFFFFFF</textcolor>
                        <label>[UPPERCASE]$ADDON[script.plexmod.zidoo 32439][/UPPERCASE]</label>
                    </control>
                    <control type="group">
                        <posx>582</posx>
                        <posy>{{ vscale(131) }}</posy>
        ...
        <control type="grouplist" id="60">
            ...
            <control type="group" id="500">
                ...
                <control type="label">
                    ...
                    <aligny>center</aligny>
                    <textcolor>FFFFFFFF</textcolor>
                    <label>[UPPERCASE]$ADDON[script.plexmod.zidoo 32440][/UPPERCASE]</label>
                </control>
            ...
            <control type="group" id="503">
                ...
                <control type="label">
                    ...
                    <aligny>center</aligny>
                    <textcolor>FFFFFFFF</textcolor>
                    <label>[UPPERCASE]$ADDON[script.plexmod.zidoo 32419][/UPPERCASE]</label>
                </control>
