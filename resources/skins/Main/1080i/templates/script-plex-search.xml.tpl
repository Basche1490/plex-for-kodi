...
<control type="label">
    ...
    <label>[UPPERCASE]$ADDON[script.plexmod.zidoo 32431][/UPPERCASE]</label>
</control>
...
<control type="group" id="899">
    ...
    <control type="group">
        ...
        <control type="group">
            ...
            <control type="label">
                ...
                <aligny>center</aligny>
                <textcolor>FFFFFFFF</textcolor>
                <label>$ADDON[script.plexmod.zidoo 32345]</label>
            </control>
        </control>
        <control type="group">
            <posx>154</posx>
    ...
    <control type="group" id="950">
        ...
        <control type="group">
            ...
            <control type="button" id="951">
                ...
                <texturefocus colordiffuse="FFE5A00D" border="50">script.plex/white-square-rounded-with-shadow.png</texturefocus>
                <texturenofocus>-</texturenofocus>
                <label>$ADDON[script.plexmod.zidoo 32322]</label>
            </control>
        </control>
        <control type="group">
            <posx>154</posx>
            ...
            <control type="button" id="952">
                ...
                <texturefocus colordiffuse="FFE5A00D" border="50">script.plex/white-square-rounded-with-shadow.png</texturefocus>
                <texturenofocus>-</texturenofocus>
                <label>$ADDON[script.plexmod.zidoo 32432]</label>
            </control>
        </control>
        <control type="group">
            <posx>308</posx>
            ...
            <control type="button" id="953">
                ...
                <texturefocus colordiffuse="FFE5A00D" border="50">script.plex/white-square-rounded-with-shadow.png</texturefocus>
                <texturenofocus>-</texturenofocus>
                <label>$ADDON[script.plexmod.zidoo 32433]</label>
            </control>
        </control>
    </control>
    ...
    <control type="group">
        ...
        <control type="label">
            ...
            <aligny>center</aligny>
            <textcolor>FFFFFFFF</textcolor>
            <label>[UPPERCASE]$ADDON[script.plexmod.zidoo 32434][/UPPERCASE]</label>
        </control>
        <control type="group">
            <posx>480</posx>
            <posy>0</posy>
    ...
    <control type="group">
        ...
        <control type="label">
            ...
            <aligny>center</aligny>
            <textcolor>FFFFFFFF</textcolor>
            <label>[UPPERCASE]$ADDON[script.plexmod.zidoo 32435][/UPPERCASE]</label>
        </control>
    </control>
</control>
