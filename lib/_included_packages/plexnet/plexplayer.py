...
class PlexPlayer(BasePlayer):
    ...
    def buildTranscode(self, server, obj, partIndex, directStream, isCurrentPart, features=None):
        ...
        maxVideoResolution = "allow_4k" in features and "99999x99999" or "1920x1080"
        ...
        builder.extras.append(
            ...
            "type=upperBound&name=video.height&value={}&isRequired=true)".format("allow_4k" in features and "99999" or
                                                                                 "1088"))
