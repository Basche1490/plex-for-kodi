...
xbmc.log('script.plexmod.zidoo: Kodi {0}.{1} (build {2})'.format(KODI_VERSION_MAJOR, KODI_VERSION_MINOR, KODI_BUILD_NUMBER),
         xbmc.LOGINFO)
...
def dumpSettings():
    ...
    try:
        ...
        LOG('script.plexmod.zidoo: No settings.xml found')
        return
