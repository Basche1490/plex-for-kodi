...
try:
    ...
    xbmc.log('script.plexmod.zidoo: Couldn\'t determine Kodi version, assuming 19.4. Got: {}'.format(sys_ver), xbmc.LOGINFO)
...
if _build:
    try:
        ...
        pass
if not parsedBuild:
    xbmc.log('script.plexmod.zidoo: Couldn\'t determine build version, falling back to Kodi version', xbmc.LOGINFO)
